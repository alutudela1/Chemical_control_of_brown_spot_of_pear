...
Authors: Marisa Andrea Aluminé Tudela*, María Cecilia Lutz, Gustavo Nestor Giménez, Susana Noemí Di Masi, Graciela Noemí Pose, Dolores Del Brío, Juan Pablo
Edwards Molina
...
```{r, echo=FALSE, out.width="50%", out.height="20%", fig.show='hold', fig.align='center', fig.cap="Abate (left) and Danjou (right) pear cultivars with symptoms of brown spot caused by *Stemphylium vesicarium*", }
knitr::include_graphics(here::here("images", c("abate_border.png","danjou_border.png"))) 
```

--- 

* *For reproducibility purposes of the data analysis, this github repository can be downloaded by:*
